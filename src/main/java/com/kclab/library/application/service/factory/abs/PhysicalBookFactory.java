...
public class PhysicalBookFactory implements AbstractBookFactory {
    ...
    public Book createFictionBook(String id, String title, String author) {
        return fictionFactory.createBook(id, title, author, BookFormat.PRINT.getValue());
    }

    @Override
    public Book createNonFictionBook(String id, String title, String author) {
        return nonFictionFactory.createBook(id, title, author, BookFormat.PRINT.getValue());
    }
}
